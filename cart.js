...
async function sendConfirmationEmail(orderDetails) {
    ...
    try {
        ...
        const customerResponse = await fetch(`${API_URL}/api/send-order-confirmation`, {
            method: 'POST',
            headers: {
        ...
        console.log('✓ Customer email sent successfully to:', orderDetails.email);

        // Send email to seller
        const sellerResponse = await fetch(`${API_URL}/api/send-order-confirmation`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
        ...
        if (sellerResult.success) {
            console.log('✓ Seller notification sent successfully to:', SELLER_EMAIL);
        } else {
            console.warn('⚠ Seller notification failed, but customer email succeeded');
        }
